    ...
    <div className={styles.main}>
      <section>
        ...
        <p className={styles.content}>
          A Full Stack Software Engineer with about {getExperience()} of
          experience in both frontend and backend development along with
          developing hybrid mobile applications.
          <br />
          Successfully led cross-functional teams, mentored junior developers
          while driving timely delivery of high-impact projects.
          <br />I thrive as a part of a team where we can have explore and
      ...
      <section>
        ...
        <section className={styles.content}>
          <h2>Frontend:</h2>
          JavaScript, TypeScript, React, Vue.js, ExtJS, Web Components, Angular,
          SASS, OAuth2
          <h2>Backend:</h2>
          Node.js, Express, NestJS, GraphQL, WebSocket, Redis, MongoDB, Kafka,
          .NET Core
          <h2>DevOps & Cloud:</h2>
          Docker, Traefik, Azure Cloud Services (Cosmos DB, APIM, AD B2C, App
          Insights, Notification Hub), AWS S3, Gitlab pipelines
          <h2>Mobile & Hybrid Apps:</h2>
          Ionic, Capacitor, Biometrics, Push Notifications, PWA, Kochava, Braze
          <h2>Other Technologies:</h2>
          Git, Apache Solr, Puppeteer, reCAPTCHA v3, SFTP, TICK Stack, Grafana,
          Form.io
          <h2>Methodologies:</h2>
      ...
      <section>
        ...
        <section className={styles.content}>
          ...
          Working with a major healthcare provider to develop a novel system to
          allow business teams to design, create and deploy new services to
          customers in real time with very minimal interaction with IT team
          hence leading to high cost savings and faster time to market,
          resposibilities include;
          <ul>
            <li>
              Work with Product team, designers, business team & architects to
              discuss & design initial solution diagram and create initial
            ...
            <li>
              ...
              technologies that can help us achieve the target state
            </li>
            <li>
              Technologies: Angular 9, Sass, Form.io, Web Components, Nodejs,
              PingID (OAuth2), Azure cloud services (Cosmos/APIM/App
              Insights/Storage/etc), BPM tools, etc
            </li>
          </ul>
          <br />
          <p className={styles.roleName}>
          ...
          <p>
            Worked with a major financial client to develop a new hybrid web app
            to accelerate business to delivery speed of Application to Android,
            iOS and Web platforms by using Ionic and Azure web services
          </p>
          <br />
          As a part of core Foundation team responsible for:
          <ul>
            <li>
              Creation and maintenance of foundational components such as
              authentication (OAuth2 via AD B2C), Biometrics
            </li>
            <li>
              Implementation of Native functionalities like Push Notifications
              (via Azure Notification Hub), Deep Linking, App share
            </li>
            <li>
              Integrate application with Kochava platform to drive app install
              attributions and analytics collection
            </li>
            <li>
              Implement omnichannel messaging platform via Braze to drive Email,
              Push notification, In-App messaging and SMS campaigns based on
              user behaviour for enhancing user interaction with the app
            </li>
            <li>
              Working closely with Product Owner’s to refine requirements,
              Architects to create system design and DevOps to update pipelines
              according to changing app needs.
            </li>
            <li>
              Technologies: Ionic, Capacitor, ReactJS, Kochava, Braze,
              Biometrics, Sass, MongoDB, reCAPTCHA v3, SFTP, Azure cloud
              services (Cosmos/APIM/AD B2C/App Insights/Storage/Notification
              Hub/etc)
            </li>
          </ul>
          <br />
